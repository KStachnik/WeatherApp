...
struct SampleWeatherData {
    ...
    static let forecastStruct = Forecast(forecastday: [forecastDayStruct, forecastDayStruct, forecastDayStruct, forecastDayStruct, forecastDayStruct])
    static let currentStruct = Current(tempC: 0.0, isDay: 1)
    static let locationStruct = Location(name: "Warsaw", localtime: "2020-09-11 10:10")
